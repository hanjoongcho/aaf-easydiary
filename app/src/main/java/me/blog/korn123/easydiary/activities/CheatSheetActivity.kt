...
open class CheatSheetActivity : EasyDiaryActivity() {
    ...
    private fun setupCheatSheet() {
        mOriginCheatSheetList.run {
            ...
            add(CheatSheetAdapter.CheatSheet("Git and Git Flow Cheat Sheet", "Describes annotations mainly used in Spring Framework", "https://raw.githubusercontent.com/arslanbilal/git-cheat-sheet/master/other-sheets/git-cheat-sheet-ko.md"))
