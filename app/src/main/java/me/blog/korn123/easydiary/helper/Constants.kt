...
const val EMOJI_HAPPY = 61
const val EMOJI_LAUGHING = 62
const val EMOJI_CRYING = 63
const val EMOJI_ANGRY = 64
const val EMOJI_TONGUE = 65
const val EMOJI_ANGRY_1 = 66
const val EMOJI_WINK = 67
const val EMOJI_DISAPPOINTED = 68
const val EMOJI_SAD = 69
const val EMOJI_EMBARRASSED = 70
