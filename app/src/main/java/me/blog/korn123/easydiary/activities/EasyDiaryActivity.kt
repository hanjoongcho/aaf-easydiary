...
open class EasyDiaryActivity :
    ...
    fun checkWhatsNewDialog(applyFilter: Boolean = true) {
        arrayListOf<Release>().apply {
            add(Release(345, R.string.release_345))
            add(Release(344, R.string.release_344))
            add(Release(343, R.string.release_343))
            add(Release(341, R.string.release_341))
            add(Release(340, R.string.release_340))
            add(Release(339, R.string.release_339))
            add(Release(338, R.string.release_338))
            add(Release(337, R.string.release_337))
            add(Release(334, R.string.release_334))
            add(Release(333, R.string.release_333))
