...
class FullBackupService : Service() {
    ...
    data class WorkStatus(
        ...
        var failCount: Int = 0,
        var targetFilenamesCursor: Int = 0,
        var remoteDriveFileNames: ArrayList<String> = arrayListOf(),
        var targetFilenames: ArrayList<String> = arrayListOf(),
    ...
    override fun onCreate() {
        ...
        mNotificationBuilder =
            NotificationCompat.Builder(applicationContext, "${NOTIFICATION_CHANNEL_ID}_alarm")
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val mChannel =
                NotificationChannel(
                    "${NOTIFICATION_CHANNEL_ID}_alarm",
                    getString(R.string.notification_channel_name_alarm),
                    importance,
                )
        ...
        mNotificationBuilder
            ...
            .setContentTitle(
                if (config.enableDebugOptionVisibleAlarmSequence) {
                    "[$NOTIFICATION_FOREGROUND_FULL_BACKUP_GMS_ID] ${
                        getString(
            ...
            if (workStatus.targetFilenames.size == 0) {
                ...
                val stringBuilder =
                    createBackupContentText(
                        workStatus.localDeviceFileCount,
                        workStatus.duplicateFileCount,
                        workStatus.successCount,
                        workStatus.failCount,
                    )
                mNotificationBuilder
                    .setStyle(
                        ...
                        if (config.enableDebugOptionVisibleAlarmSequence) {
                            ...
                            } ${workStatus.successCount + workStatus.failCount}/${workStatus.targetFilenames.size}"
                        } else {
                            "${
                                getString(
                                    R.string.notification_msg_upload_progress,
                        ...
                        workStatus.targetFilenames.size,
            ...
            resultNotificationBuilder
                ...
                .setLargeIcon(
                    BitmapFactory.decodeResource(
                        resources,
                        R.drawable.ic_googledrive_upload,
                    ),
                ).setOngoing(false)
                .setAutoCancel(true)
