...
class BackupPhotoService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val mChannel =
                NotificationChannel(
                    "${NOTIFICATION_CHANNEL_ID}_upload",
                    getString(R.string.notification_channel_name_upload),
                    importance,
                )
            ...
            notificationBuilder
                .setStyle(
                    ...
                    if (config.enableDebugOptionVisibleAlarmSequence) {
                        ...
                        }  ${successCount + failCount}/${targetFilenames.size}"
                    } else {
                        "${getString(R.string.notification_msg_upload_progress)}  ${successCount + failCount}/${targetFilenames.size}"
                    },
            ...
            .setContentTitle(
                if (config.enableDebugOptionVisibleAlarmSequence) {
                    "[$NOTIFICATION_GMS_BACKUP_COMPLETE_ID] ${
                        getString(
                            R.string.backup_attach_photo_title,
                        )
                    }"
                } else {
