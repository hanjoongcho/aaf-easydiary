    ...
    EasyDiaryDbHelper
        ...
        ?.let {
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                var sha: String? = null
                val findCall =
                    retrofitApiService.getContentsDetail(it, "hanjoongcho", "self-development", path)
...
fun ComponentActivity.syncMarkDown(
    ...
    lifecycleScope.launch(Dispatchers.IO) {
        ...
        EasyDiaryDbHelper.getTemporaryInstance().run {
            EasyDiaryDbHelper.findDiary("GitHub Personal Access Token", false, 0, 0, 0, this).also {
                size = it.size
