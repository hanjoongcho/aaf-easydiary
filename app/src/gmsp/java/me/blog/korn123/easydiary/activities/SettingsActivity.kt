...
class SettingsActivity : EasyDiaryActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragmentList = arrayListOf(SettingsBasicFragment(), SettingsFontFragment(), SettingsLockFragment(), SettingsGMSBackupFragment(), SettingsLocalBackupFragment(), SettingsAppInfoFragment())
